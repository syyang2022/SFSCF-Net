...
class ResNet(nn.Module):
    ...
    # def FBSM(self, fm, inchanel, k):
    #     b, c, w, h = fm.shape
    #     fms = torch.split(fm, w // k, dim=2)
    #     fms_conv = map(self.stripconv(inchanel), fms)
    ...
    #     fms_softmax_boost = torch.repeat_interleave(fms_softmax, w // k, dim=2)
    #     alpha = 0.5
    ...
    #     fms_softmax_suppress = torch.repeat_interleave(fms_softmax_suppress, w // k, dim=2)
